...
html_kopf("Buch Neu",true,"js/onload_focus.js","","js/dat_b_neu.js");
?>
...
<b>Buchtitel:</b><br />
<input id="focus" type="text" name="c_bo_title" value="" size="50" maxlength="100" /><br /><br />
<b>Gelesen : </b><input type="checkbox" name="c_bo_has_read" value="v" /><br /><br />
<b>Auflagedaten:</b><br />
<input type="text" name="c_bo_print_run" value="" size="50" maxlength="50" /><br /><br />
<b>Preis EUR: </b><input type="text" name="c_bo_price" value="0,0" size="8" maxlength="8" onblur="test_float(this)" /><b>&nbsp;&nbsp; ISBN(EAN): </b><input type="text" name="c_bo_isbn" value="" size="20" maxlength="20" ondblclick="_10_to_13(this)" onblur="test_isbn(this)" /><br /><br />
<b>Buchabmessung (mm):</b><br />
<b>Höhe: </b><input type="text" name="c_bo_height" value="0" size="3" maxlength="3" onblur="test_int(this)" />mm<b>
&nbsp;&nbsp;Tiefe: </b><input type="text" name="c_bo_deep" value="0" size="3" maxlength="3" onblur="test_int(this)" />mm<b>
&nbsp;&nbsp;Breite: </b><input type="text" name="c_bo_width" value="0" size="3" maxlength="3" onblur="test_int(this)" />mm<br />
<br />
<b>Buchgewicht (gramm): </b><input type="text" name="c_bo_weight_gr" value="0" size="5" maxlength="5" onblur="test_int(this)" /><br /><br />
...
<b>Datenträger:</b><input type="checkbox" name="c_bo_has_dc" value="v" /><b>  Lagert: </b><span id="ziel_r_dc"></span><span class="button" onclick="search_data('storage_dc');">Suche Regal</span><br /><br />
...
<b>Kommentar:</b><br />
<textarea name="c_bo_comment" cols="50" rows="5"></textarea><br /><br />
<b>Verleihstatus:</b><br />
<input type="text" name="c_bo_conferred" value="" size="40" maxlength="40" /><br /><br /> 
