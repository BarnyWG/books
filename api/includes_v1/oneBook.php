...
function oneBook($zielID) {
  ...
  $sequence = file_get_contents('../sequence_v1/book.sequence');
  ...
  if($result->rowCount()) { # Buch gefunden Anpassung im String vornehmen
    ...
    # $dummy1 = str_replace(PHP_EOL, ' ', $dummy1); # CRLF gegen Leerzeichen funktioniert nicht unter Linux
    ...
    $dummy2 = str_replace(array("\r\n", "\n", "\r"), ' ', $dummy2); # CRLF gegen Leerzeichen
    ...
    $dummy3 = str_replace(array("\r\n", "\n", "\r"), ' ', $dummy3); # CRLF gegen Leerzeichen
